...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    _services_BookService__WEBPACK_IMPORTED_MODULE_0__["default"].getBookDetails(this.$route.params.id, this.$route.params.bookType).then(function (_ref) {
      var data = _ref.data;
      console.log(data);
      _this.book = data.details;
    });
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    _services_BookService__WEBPACK_IMPORTED_MODULE_0__["default"].getReadingList().then(function (_ref) {
      var data = _ref.data;
      _this.list = data.books;
    });
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    search: function search() {
      ...
      _services_BookService__WEBPACK_IMPORTED_MODULE_0__["default"].search(this.q).then(function (_ref) {
        var data = _ref.data;
      ...
      _c("div", { staticClass: "col-md-10" }, [
        _c("div", { staticClass: "card-body" }, [
          ...
          _c("p", { staticClass: "card-text" }, [
            _vm._v(_vm._s(_vm._f("truncate")(_vm.book.description, 250)))
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "card-text" }, [
            _c(
              ...
              _vm._l(_vm.book.authors, function(author) {
                return _c("span", [_vm._v(_vm._s(author) + " ")])
              }),
              0
            )
          ]),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  getReadingList: function getReadingList() {
    return vue__WEBPACK_IMPORTED_MODULE_0___default.a.axios.get('list');
  },
  ...
  search: function search(q) {
    return vue__WEBPACK_IMPORTED_MODULE_0___default.a.axios.get("books?q=".concat(q));
  }
});
